...
function AppointmentList() {
    ...
    const loadAppointments = async () => {
        try {
            const response = await axios.get('https://final-project-patika.onrender.com/api/v1/appointmentDate');
    ...
    const fetchDoctorById = async (doctorId) => {
        try {
            const response = await fetch(`https://final-project-patika.onrender.com/api/v1/doctor/${doctorId}`);
            if (!response.ok) {
    ...
    const fetchAnimalById = async (animalId) => {
        try {
            const response = await fetch(`https://final-project-patika.onrender.com/api/v1/animal/${animalId}`);
            if (!response.ok) {
